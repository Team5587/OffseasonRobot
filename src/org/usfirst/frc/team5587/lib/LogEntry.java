...
public class LogEntry {
	...
	public double time, lEncDist, rEncDist, lVel, rVel, heading, xPos, yPos, vBat, totalCurrent;
	 ...
	 * 
	 */
	public LogEntry(double time, double lEncDist, double rEncDist, double lVel, double rVel, double heading,
			double xPos, double yPos, double vBat, double totalCurrent) {
		this.time = time;
