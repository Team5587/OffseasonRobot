...
public class Log {
	 ...
	 */
	public void addEntry( double lEncDist, double rEncDist, double lVel, 
			double rVel, double heading, double xPos, double yPos){
		double time = Timer.getFPGATimestamp();
		double vBat = pdp.getVoltage();
		double totalCurrent = pdp.getTotalCurrent();
		log.add(new LogEntry(time, lEncDist, rEncDist, lVel, 
			rVel, heading, xPos, yPos, vBat, totalCurrent ));
	}
	
	/**
	 * 
	 * @param time the timestamp of the desired LogEntry
	...
	/**
	 * 
	 * @param indexAgo How many entries ago to look at
